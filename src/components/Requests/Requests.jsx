        ...
        return (
          <div className="flex justify-between items-center">
            <div className="flex justify-between items-center gap-[10px]">
              <img src={requested.img} alt="" className="w-12 h-12 rounded-[18px]" />
            ...
            <div className="flex items-center justify-center mr-2 gap-2">
              <button className="button text-[13px] w-16 bg-[#fffc54]">Accept</button>
              <button className="button text-[13px] w-16 bg-red-500">Reject</button>
            </div>
          </div>
        );
      })}
